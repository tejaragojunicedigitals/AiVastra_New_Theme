...
class ShowAppAlertDialog(private val imageSourceType: ImageSourceType,
    ...
    private lateinit var errorAlertBinding: DialogAppAlertBinding

    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View {
        errorAlertBinding = DialogAppAlertBinding.inflate(inflater, container, false)
        initView()
